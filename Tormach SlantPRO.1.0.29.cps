...
2020-07-18 : Add line feed before coolant-on
2020-12-08 : Removed: query for argument[0] needing to be boolean.
2020-12-11 : Added: support tapered thread ('D' parameter in G76)
...
var dtFormat = createFormat({decimals:(unit === MM ? 3 : 4), forceDecimal:true}); // thread taper
...
var dtOutput = createVariable({prefix:"D", force:true}, dtFormat);
...
function onCyclePoint(x, y, z) {
    ...
    switch ( cycleType ) {
        case "thread-turning":
            ...
            var pos_other = backFromFront ? currentSection.getInitialPosition( ) : currentSection.getFinalPosition( );
...
//debugOut( "p= " + p_value, "driveline= " + driveLineOffset, "threadCrest= " + threadCrest, "threadDepth= " + threadDepth );            
            ...
            writeBlock( gMotionModal.format(76),
                        ...
                        d_value != 0.0 ? dtOutput.format( d_value ) : "" );
            return;
        case "drilling":
        case "counter-boring":
        case "chip-breaking":
